...
@app.route('/players/change_pass/<int:player_id>/<old_password>/<new_password>',
           methods=['POST'])
...
@app.route('/chat/get_whiteboard/<whiteboard_tag>')
...
@app.route('/profile_manager/sign_in/<login>/<password>', methods=['GET'])
